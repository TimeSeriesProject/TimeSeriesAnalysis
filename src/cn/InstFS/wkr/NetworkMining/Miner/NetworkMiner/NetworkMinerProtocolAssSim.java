...
import cn.InstFS.wkr.NetworkMining.Miner.NetworkMiner.FPTimerTask;
...
public class NetworkMinerProtocolAssSim implements INetworkMiner {
	TaskElement task;
	...
	public NetworkMinerProtocolAssSim(TaskElement task,IReader reader) {
		this.task = task; 
		this.reader=reader;
	...
	public boolean start() {
		System.out.println("NetworkMinerProtocolAssSim   timer开始");
		if (timer != null){
