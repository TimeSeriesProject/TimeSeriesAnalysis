...
import cn.InstFS.wkr.NetworkMining.Miner.Algorithms.PartialPM;
import cn.InstFS.wkr.NetworkMining.Miner.Algorithms.averageEntropyPM;
...
class PMTimerTask extends TimerTask{
	...
	IReader reader;
	public PMTimerTask(TaskElement task, MinerResults results, IResultsDisplayer displayer,IReader reader,Timer timer,IsOver isOver) {
		this.task = task;
