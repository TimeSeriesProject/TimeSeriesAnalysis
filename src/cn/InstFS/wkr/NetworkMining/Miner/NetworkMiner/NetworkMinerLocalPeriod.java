...
public class NetworkMinerLocalPeriod implements INetworkMiner {

	public NetworkMinerLocalPeriod(TaskElement task,IReader reader){
...
public class NetworkMinerLocalPeriod implements INetworkMiner {
	...
	public boolean start() {
		System.out.println("PanelShowResultsNetworkMinerLocalPeriod   timer开始");
		if (timer != null){
...
class LPTimerTask extends TimerTask{
	...
	IReader reader;
	public LPTimerTask(TaskElement task, MinerResults results, IResultsDisplayer displayer,IReader reader,Timer timer,IsOver isOver) {
		this.task = task;
