...
//			System.out.println("godend"+dataItemArray[left.ptindex[1]]);
	...
	void fixdown(MergeSegmentNode x)
	{
		...
		{
			int cindex=2*index;
			if(index*2<=size&&nodes[index].error>nodes[2*index].error) //��ʡ��
				cindex=2*index;
...
//		System.out.println();
	...
	public ArrayList<PatternMent> getPatterns()
	{
		...
		int pre = -1;
		double maxSpan=Double.MIN_VALUE,maxSlope=Double.MIN_VALUE,maxAverage=Double.MIN_VALUE;  //�洢���ʱ��������������仯�ľ���ֵ
...
//			System.out.println(seg.slope+",");
	...
	public ArrayList<Segment> getSegmentList()
	{
		...
		int pre = -1;
		double maxLength=Double.MIN_VALUE,maxSlope=Double.MIN_VALUE,maxCentery=Double.MIN_VALUE;  //�洢���ʱ��������������仯�ľ���ֵ
